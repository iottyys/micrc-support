...
CREATE UNIQUE INDEX CAMEL_MESSAGE_IDEMPOTENT_REPOSITORY_IDX ON CAMEL_MESSAGE_IDEMPOTENT_REPOSITORY (REGION, GROUP_KEY, MESSAGE_PRIORITY DESC, CREATED_DATE, MESSAGE_SEQUENCE);
